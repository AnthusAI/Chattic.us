...
image and is not wired as the live `ComputerActionExecutor`. There is no
chattic.us web app, no pull worker that finishes a browser tool on a
running host, and no approvals on these slices.

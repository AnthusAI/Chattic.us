...
export const alt = `Chatticus — ${FLEXIBLE_COMPUTE_PAGE_CONTENT.ogTitle}`;
export const size = OG_IMAGE_SIZE;
export const contentType = "image/png";

export default function Image() {
  return renderOgImage({
    headline: FLEXIBLE_COMPUTE_PAGE_CONTENT.ogHeadline,
    tagline: FLEXIBLE_COMPUTE_PAGE_CONTENT.ogTagline,
  });
}

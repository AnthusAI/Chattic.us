...
import { TERMS_PAGE_CONTENT } from "./page-content";

export const metadata: Metadata = {
  title: TERMS_PAGE_CONTENT.title,
  description: TERMS_PAGE_CONTENT.description,
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    type: "website",
    url: "/terms",
    title: TERMS_PAGE_CONTENT.ogTitle,
    description: TERMS_PAGE_CONTENT.ogDescription,
    siteName: "Chatticus",
  },
  twitter: {
      ...
      <main id="main-content">
        <section className="bg-surface">
          <div className="mx-auto max-w-[92rem] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
            ...
            <div className="mt-12">
              <MarkdownContent>{TERMS_PAGE_CONTENT.body}</MarkdownContent>
            </div>
          </div>
        </section>
      </main>
